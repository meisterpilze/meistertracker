...
- **Security vulnerabilities:** please file a private [Security Advisory](https://github.com/loewenmaehne/meistertracker/security/advisories/new) — do **not** open a public issue. See [SECURITY.md](SECURITY.md).
