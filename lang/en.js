...
window.LANG['en'] = {
  ...
  'sub.moistureActual': 'Measured moisture',
  'sub.rhNotMeasured': 'not measured yet',
  'sub.rhAdd': 'Record measured moisture',
  'sub.rhEdit': 'Change measured moisture',
  'sub.rhPrompt': 'Measured moisture for {id} in % (empty = clear)',
  'sub.rhSaved': 'Measured moisture {pct} % saved',
  'sub.rhCleared': 'Measured moisture cleared',
