...
window.LANG['en'] = {
  ...
  'batch.grainJars': 'Grain',
  'batch.legendToggle': 'What do the colours mean?',
  'batch.legendNote': 'Grain and incubation count separately: incubation is the next harvest, grain is what the one after that gets made from. Grain is counted in jars, everything else in bags.',
