...
window.LANG['en'] = {
  ...
  'settings.tabPickupLocations': 'Pickup locations',
  'pickupLoc.title': 'Pickup locations',
  'pickupLoc.desc':
    'Places where goods are handed over — the hall, a market stall, a second site. A calendar entry picks one of these instead of having the place typed into its title: typed, the second spelling shows up sooner or later, and whoever reads the name outside then sees two markets. The name leaves the building with the harvest feed; the address does not.',
  'pickupLoc.add': '+ Pickup location',
  'pickupLoc.edit': 'Edit',
  'pickupLoc.name': 'Name',
  ...
  'orders.f.sku': 'SKU',
  'orders.f.item': 'Item',
  'orders.th.privacy': 'Privacy',
  'orders.erase': 'Erase data',
  'orders.erased': 'erased',
  'orders.eraseTitle': 'Permanently erase customer data?',
  'orders.eraseMsg':
    'The name, email and every shipping address for {name} will be erased and will not return on the next channel sync.\n\nOrders and revenue are kept. Tracking data for a parcel still in transit is kept until it is delivered.',
  'orders.eraseYes': 'Yes, erase',
  'orders.eraseDone': '{name} erased ({n} orders cleaned)',
  ...
  'strains.minMc': 'Minimum slants (pieces)',
  'strains.minPd': 'Minimum petri dishes (pieces)',
  'todo.labShort': '{type}: {have} of {min}',
  'todo.labGroup': '{n} Sorten below their lab minimum',
  'todo.labGroupOpen': 'Show',
  'todo.labGroupClose': 'Collapse',
  'todo.labMake': 'Make {type}',
  'sub.tab': 'Substrate mixes',
  'sub.allTitle': 'Substrate mixes',
  'sub.showSpent': 'Show spent',
  'sub.summary': '{total} mixes in total · {open} open holding {kg} kg · {bad} written off',
  'sub.burst': 'Burst in the autoclave',
  'sub.burstNone': 'none',
  'sub.burstN': '{n} bag(s)',
  'sub.burstAdd': 'Burst bags',
  'sub.burstEdit': 'Edit burst bags',
  'sub.burstPrompt': 'How many bags from {id} burst in the autoclave?',
  'sub.burstHint': 'e.g. 4 — leave empty for none',
  'sub.burstNaN': 'Please enter a whole number from 0 up',
  'sub.burstSaved': '{n} burst bag(s) recorded',
  'sub.burstCleared': 'Record cleared — no burst bags',
  'sub.burstSummary': '{n} bag(s) burst across {m} mix(es)',
  'sub.noneAtAll': 'No mix created yet.',
  'sub.thId': 'Number',
  'sub.thRecipe': 'Recipe',
  'sub.thMade': 'Mixed',
  'sub.thUsed': 'Used',
  'sub.thLeft': 'Left',
  'sub.thStatus': 'Status',
  'sub.thBatches': 'Batches',
  'sub.stOpen': 'open',
  'sub.stUsed': 'spent',
  'sub.stBad': 'written off',
  'sub.madeOn': 'Mixed on {date} to {recipe}',
  'sub.howMade': 'How it was mixed',
  'sub.blend': 'Blend (pellets / bran / corn)',
  'sub.booked': 'Taken off the shelf',
  'sub.drawnBy': 'Batches made from it',
  'sub.drawnNone': 'Nothing made from it yet.',
  'sub.leftNow': 'Left: {kg} kg of {of} kg',
  'sub.writeOff': 'Write off mix',
  'sub.writeOffTitle': 'Write off mix?',
  'sub.writeOffMsg': '{id} is marked written off and the remaining {kg} kg count as lost. The material stays booked as used — it was mixed either way.',
  'sub.writeOffNote': 'written off',
  'sub.delete': 'Delete mix',
  'sub.deleteTitle': 'Delete mix?',
  'sub.deleteMsg': 'Nothing has been made from {id}, so this reverses cleanly: pellets, bran and gypsum go back on the shelf.',
  'strains.recCornPct': 'Corn meal %',
  'strains.recGypsumPct': 'Gypsum % of dry mix',
  'strains.recSpawnPct': 'Spawn % of substrate',
  'strains.recRef': 'Recipe sheet: colonisation {colon} · sterilise {steril}',
  'inv.corn': 'Corn meal',
  ...
  'sub.gypsum': 'Gypsum',
  'sub.water': 'Water',
  'sub.waterTime': 'Watering time',
  'sub.moisture': 'Target moisture',
  'sub.moistureActual': 'Measured RH',
  'sub.rhNotMeasured': 'not measured yet',
  'sub.rhAdd': 'Record Measured RH',
  'sub.rhEdit': 'Change Measured RH',
  'sub.rhPrompt': 'Measured RH for {id} in % (empty = clear)',
  'sub.rhSaved': 'Measured RH {pct} % saved',
  'sub.rhCleared': 'Measured RH cleared',
  'sub.rhNaN': 'Please enter a number, e.g. 62.5',
  'sub.rhMeasuredAt': 'Measured {when}',
  'sub.rhMeasuredBy': 'Measured {when} by {who}',
  'sub.comment': 'Comment',
  'sub.commentNone': 'none',
  'sub.commentAdd': 'Add comment',
  'sub.commentEdit': 'Change comment',
  'sub.commentPrompt': 'Comment on {id} (empty = clear)',
  'sub.commentPlaceholder': 'e.g. pellets were wetter than usual',
  'sub.commentSaved': 'Comment saved',
  'sub.commentCleared': 'Comment cleared',
  'sub.noSpawnHint': 'Spawn is charged with the Charge, not here — a mix does not know yet what will grow in it.',
  'sub.confirmTitle': 'Create mix?',
  'sub.confirmMsg': '{kg} kg to {recipe} as {id}. The material comes off the shelf now.',
  ...
  'sub.drawLine': '{qty} bags × {bagKg} kg = {need} kg out of the mix',
  'sub.leftAfter': 'Left afterwards: {left} kg',
  'sub.overdraw': 'Overdraws the mix by {over} kg',
  'sub.spawnLine': 'Spawn: {kg} kg',
  'sub.overdrawTitle': 'More than is left?',
  'sub.overdrawMsg': 'This Charge needs {need} kg and the mix holds {left} kg. Create it anyway? (The remainder is set to 0.)',
  'sub.batchDone': '{id} created — {kg} kg taken, {left} kg left in the mix.',
  ...
  'msq.recNoBagKg': 'Recipe incomplete: no bag weight set.',
  'msq.recNoCoir': 'Recipe incomplete: no coir/CVG share set.',
  'msq.recNoGrainKg': 'Recipe incomplete: no grain amount set.',
  'msq.recBadSplit': 'Recipe incomplete: hardwood + wheat bran total {sum}%, not 100%.',
  'msq.noRecipesTitle': 'No recipe defined yet',
  'msq.noRecipesMsg': 'No mushroom strain has a production recipe yet. A batch cannot be created without one.',
  'msq.noRecipesGo': 'Go to strains',
  ...
  'channels.ebayVerifyToken': 'Verification token (account deletion)',
  'channels.ebayVerifyHint':
    'A secret you make up, 32–80 characters (A–Z, a–z, 0–9, _ and -). Enter the identical value in the eBay developer portal under "Marketplace account deletion", together with the endpoint URL below.',
  ...
  'dash.destLabel': 'Target:',
  'dash.openDay': 'Open this day',
  'dash.viewWeek': 'Week',
  'dash.viewDay': 'Day',
  'dash.dayPrev': 'Previous day',
  'dash.dayNext': 'Next day',
  ...
  'dayqty.plan': 'Weekly plan',
  'dayqty.planHint': 'applies to every {day} — changes the weekly rhythm',
  'dayqty.planLocked': 'applies to every {day} · only admins change this',
  'dayqty.extra': 'Extra this week only',
  'dayqty.extraHint': 'An exception for {date} alone, e.g. when this week needs more. Empty or 0 = as usual.',
  'dayqty.sum': 'Makes {n} on {date}',
  'dayqty.bad': 'Please enter whole numbers; together between 0 and 100000.',
  'dayqty.planOnly': 'The weekly plan was saved, the day was not: {err}',
  ...
  'rhythm.startNone': 'from the first batch',
  'rhythm.startPrompt': 'From which day should the rhythm count? (YYYY-MM-DD, empty = from the start)',
  'rhythm.startSaved': 'Start date saved',
  'rhythm.planned': 'planned',
  'rhythm.carriedFrom': '{n} still open from {date}',
  'rhythm.qtyPh': 'Qty',
  ...
  'rhythm.theme.substrate': 'Batches',
  'recur.title': 'Own jobs',
  'recur.cat': 'Jobs',
  'recur.hint': 'Whatever else comes round regularly and leaves no record — cleaning, servicing, checking. Ticked off, not counted.',
  'recur.none': 'No job of your own yet.',
  'recur.namePh': 'e.g. clean the grow rooms',
  'recur.add': 'Add',
  'recur.remove': 'Remove',
  'recur.edit': 'Edit',
  'recur.pause': 'Pause',
  'recur.resume': 'Resume',
  'recur.paused': 'paused',
  'recur.saved': 'Job saved',
  'recur.removeAsk': 'Remove “{name}” for good?',
  'recur.removeWithTicks': 'Remove “{name}” for good? {n} ticks go with it. To stand it down, use “Pause”.',
  'recur.added': '“{name}” added',
  'recur.needName': 'Please enter a name',
  'recur.saveFailed': 'Could not be saved',
  'recur.everyWeek': 'every week',
  'recur.everyN': 'every {n} weeks',
  'recur.tick': 'Done',
  'recur.undo': 'Undo',
  'recur.missedFrom': 'open from {date}',
  'rhythm.theme.grain': 'Grain spawn',
  'rhythm.theme.free': 'free',
  'rhythm.theme.fruiting': 'Fruiting',
  'rhythm.theme.harvest': 'Harvest',
  'rhythm.theme.lab': 'Lab',
  'rhythm.theme.none': 'no theme',
  'rhythm.nothing': 'nothing planned',
  'rhythm.done': '{done} of {total} done',
  'rhythm.other': 'Other',
  'rhythm.day.0': 'Sun',
  'rhythm.day.1': 'Mon',
  'rhythm.day.2': 'Tue',
  ...
  'rhythm.day.5': 'Fri',
  'rhythm.day.6': 'Sat',
  'dash.bulkFruiting': 'All → Fruiting',
  'dash.bulkFruitingTitle': 'Move to fruiting?',
  'dash.bulkFruitingMsg': 'Move all {n} bags from “{zone}” to {dest}?',
  'dash.bulkFruitingDone': '{n} bags → {dest}',
  'dash.sec.overdue': 'Overdue',
  ...
  'dash.doInoculate': 'Inoculate',
  'dash.stillIn': 'still in {stage}',
  'dash.moreRows': '{n} more',
  'dash.fewerRows': 'show fewer',
  'dash.undo': 'Undo',
  ...
  'dash.sumMove': 'to move',
  'dash.sumHarvest': 'to harvest',
  'worklist.print': 'Print',
  'worklist.empty': 'Nothing to do.',
  'worklist.bags': 'bags',
  ...
  'batch.locationsTab': 'Locations',
  'batch.groupByAria': 'Group the list',
  'batch.groupNone': 'No grouping',
  'batch.groupSorte': 'By Sorte',
  'batch.groupStage': 'By stage',
  'batch.bySorte': 'By Sorte',
  'batch.allSorten': 'All Sorten',
  'batch.noSorte': 'No Sorte',
  'batch.bagsNBatches.one': 'bags · 1 batch',
  'batch.bagsNBatches.other': 'bags · {n} batches',
  'batch.nTotalNArchived': 'batches total: {n} · archived: {a}',
  'batch.nextDue': 'next {d}',
  'batch.lastAgo': 'last one {n} d ago',
  'batch.supply.now': 'Start one now',
  'batch.supply.nospawn': 'No grain',
  'batch.supply.low': 'Thin',
  'batch.supply.ok': 'Running',
  'batch.supply.nowWhy': 'no grain, nothing incubating \u2014 once the fruiting blocks are done, this Sorte is empty',
  'batch.supply.nospawnWhy': 'incubation is running but there is no grain \u2014 the harvest after next has nothing to start from',
  'batch.supply.lowWhy': 'less is coming through than is currently fruiting',
  'batch.supply.okWhy': 'grain in stock and more incubating than fruiting',
  'batch.supply.off': 'Not in the programme',
  'batch.supply.offWhy': 'not being grown right now \u2014 nothing is reported for this Sorte',
  'batch.nOffProgramme': '{n} not in the programme',
  'strains.imProgramm': 'In the programme',
  'strains.imProgrammAria': '{name} in the programme \u2014 on or off',
  'strains.progOn': 'yes',
  'strains.progOff': 'no',
  'todo.supplyNoSorte': 'This Sorte is not listed under Pilzsorten',
  'todo.makeGrain': 'Make grain spawn',
  'todo.makeBatch': 'Start a batch',
  'batch.grainStockKg': 'Grain kg',
  'batch.legendToggle': 'What do the colours mean?',
  'batch.legendNote': 'Grain and incubation count separately: incubation is the next harvest, grain is what the one after that gets made from. Grain is measured in kilograms, everything else counted in bags.',
  'batch.nNeedStart': '{n}\u00d7 start one now',
  'batch.nNoSpawn': '{n}\u00d7 no grain',
  'batch.tileSortAria': 'Sort the Sorten',
  'batch.tileSortUrgency': 'Sort: urgency',
  'batch.tileSortBags': 'Sort: bags',
  'batch.tileSortName': 'Sort: name',
  'batch.newBatch': 'New batch',
  'batch.harvests': 'Harvests',
  'batch.createNew': 'Growbag batch',
  ...
  'batch.substrate': 'Substrate',
  'batch.noDeduction': 'no material deducted',
  ...
  'batch.spawnConsumed': '{n} grain bag(s) written off for {id}',
  'batch.none': '\u2014 none \u2014',
  'inoc.label': 'Inoculated with (optional)',
  'inoc.scan': 'Scan',
  'inoc.hint': 'Liquid culture, petri, master culture or grain spawn — scan or pick',
  'inoc.pick': '— pick a culture or grain bag —',
  'inoc.added': '{id} recorded',
  'inoc.already': '{id} is already listed',
  'inoc.notUsable': '{id} is not an available culture or grain bag',
  'inoc.spentTitle': 'Inoculant used up?',
  'inoc.spentMsg': 'Was {names} fully used up for {id}?\n\nYes removes it from inventory. No leaves it untouched.',
  'inoc.spentYes': 'Yes, used up',
  ...
  'batch.strainLabel': 'Strain designation',
  ...
  'lab.syringes': 'Liquid syringes',
  'lab.syPrep': 'Fill liquid syringes',
  'lab.qtySyringes': 'Number of syringes',
  'lab.sourceLcPdMc': 'Source (liquid culture / petri / slant)',
  ...
  'lab.setMinFarm': '{type} — minimum for the farm',
  'lab.setMinAll': '{type} — minimum for all {n} Sorten in the programme',
  'lab.setMinOne': '{sorte} — {type} minimum',
  'lab.setMinOneHint': 'Set the minimum for {sorte}',
  'lab.setMinNoStrains': 'No Sorte is in the programme',
  'lab.setMinDone': 'Minimum set for {n} Sorten',
  'lab.kgUnit': 'kg',
  ...
  'caldav.appPwTitle': 'App passwords for calendar apps',
  'caldav.appPwDesc': 'A calendar app stores whatever password you give it \u2014 in a keychain, in a cloud backup, often longer than the device lasts. Create one here per device instead of typing your account password: it opens calendars and nothing else, and you can revoke a single device without changing your login.',
  'caldav.appPwLabelPh': 'Device name, e.g. iPhone',
  'caldav.appPwCreate': 'Create',
  'caldav.appPwOnce': 'Copy it now \u2014 it is shown this once and never again.',
  'caldav.appPwNone': 'No app passwords yet.',
  'caldav.appPwDevice': 'Device',
  'caldav.appPwCreated': 'Created',
  'caldav.appPwLastUsed': 'Last used',
  'caldav.appPwRevoke': 'Revoke',
  'caldav.appPwRevokeConfirm': 'This device loses access to the calendars. Other devices stay connected.',
  'caldav.appPwNeedLabel': 'Please enter a device name.',
  'caldav.howToConnect': 'How to connect',
  'caldav.howItWorks': 'How it works',
  'caldav.copyUrl': 'Copy URL',
  'caldav.loginHint':
    '<strong>Login:</strong> Your usual username. For the password, prefer an <strong>app password</strong> (below) over your account password \u2014 the calendar app keeps it for good.',
  'caldav.hiwShared':
  ...
  'harvestFeed.urlHint':
    'Must be https. http is allowed for localhost only, so you can try it against a local receiver first.',
  'harvestFeed.secret': 'Shared secret',
  'harvestFeed.secretHint':
    'The receiving side needs the same value. It signs every request, so the receiver can tell your numbers from someone else’s — without it, anyone could post “we have 40 kg” and it would look real.',
  ...
  'harvestFeed.connTitle': 'Where it goes',
  'harvestFeed.connDesc':
    'The address the messages are sent to and the key they are signed with — typed once and then left alone.',
  ...
  'harvestFeed.saveHint': 'All three cards are one setting and are saved together.',
  'harvestFeed.testNow': 'Send one now',
  'harvestFeed.preview': 'Show what would be sent',
  'harvestFeed.building': 'Building …',
  'harvestFeed.sending': 'Sending …',
  'harvestFeed.saved': 'Saved.',
  'harvestFeed.previewOk': 'Nothing sent. Harvested / planned:',
  'harvestFeed.testOk': 'Delivered. Harvested / planned:',
  'harvestFeed.testFailed': 'Not delivered',
  'harvestFeed.lastOk': 'Last delivered:',
  'harvestFeed.lastFailed': 'Last attempt failed:',
  ...
  'labCheck.title': 'Check cultures',
  'labCheck.missingUsed': '{n} not found → used up',
  'labCheck.scanUnknown': '{id} is not a known culture',
  'labCheck.scanRevived': '{id} was written off → active again',
  'labCheck.confirmTitle': 'Mark as used up?',
  'labCheck.confirmMsg': 'Mark {n} cultures that were not found as used up?',
  'labCheck.done': '{n} cultures marked used up',
  'zoneCheck.scanBtn': 'Scan bags',
  'zoneCheck.scanOk': '✓ {found} of {total}',
  'zoneCheck.scanDup': '{bag} already ticked',
  'zoneCheck.scanMoved': '{bag} was recorded elsewhere → {zone}',
  'zoneCheck.scanUnknown': '{bag} belongs to no batch',
  'zoneCheck.corrected': '{n} corrected',
  ...
  'bagInfo.moveElsewhere': 'Move elsewhere',
  'bagInfo.discard': 'Discarded',
  'bagInfo.scopeSingle': 'This bag',
  'bagInfo.scopeBatch': 'Whole batch \u00b7 {n}',
  ...
  'contam.targetBags': '{n} bags',
  'contam.scanMore': '+ Scan bags',
  'contam.removeBag': 'Drop {bag} from this report',
  'contam.collected': '{bag} marked ({n})',
  'contam.uncollected': '{bag} unmarked ({n})',
  'contam.reportN': 'Report ({n})',
  'contam.reportsSaved': '{n} reports saved',
  'contam.reportsSavedAutoMoved': '{n} reports saved — {moved} bag(s) moved to CONTAM',
  'contam.type': 'Type',
  'contam.severity': 'Severity',
  'contam.sevMinor': 'Minor',
  'contam.sevMajor': 'Moderate',
  'contam.sevLost': 'Total loss',
  ...
  'contam.errNoTarget': 'No bag and no batch in this report',
  'contam.batchWhileCollecting': 'Report the {n} scanned bags first',
  ...
  'zones.add': 'Add zone',
  'zones.delete': 'Delete',
  'zones.capacityPrompt': 'Maximum bags for “{zone}” — leave empty for no limit:',
  'zones.capacitySaved': 'Capacity saved',
  'zones.capacityNone': 'no limit',
  'zones.capacityBad': 'Please enter a whole number of 0 or more',
  ...
  'calEntry.cat.pickup': 'Pickup window',
  'calEntry.place': 'Place',
  'calEntry.placeNone': 'No place',
  'calEntry.capacity': 'Seats (optional)',
  'calEntry.capacityPh': 'empty = uncapped',
  'calDetail.seats': '{n} seats',
  ...
  'settings.tabHarvestFeed': 'Harvest feed',
  ...
  'duckdns.updaterStopped': 'DuckDNS updater is not running. The address is no longer being updated.',
  'duckdns.stale': 'Last successful update was {min} min ago. The record is probably stale.',
  'duckdns.conflict': 'The record keeps being overwritten \u2014 is the same token in use somewhere else?',
  'duckdns.mismatch': 'Nameservers serve {served}, not {expected}.',
  ...
  'work.grainWhen': 'when a liquid culture is ready',
  'work.batch': 'Create batch',
  'work.batchWhen': 'when grain spawn has colonised',
  'work.substrate': 'Mix substrate',
  'work.substrateWhen': 'books pellets, bran and gypsum out of stock',
  'work.move': 'Move',
  'work.moveWhen': 'incubation → tent → storage',
  'work.harvest': 'Log harvest',
  'work.harvestWhen': 'grams per bag, after picking',
  'work.contam': 'Report contamination',
  'work.contamWhen': 'as soon as you see it, not later',
  'work.back': 'Back',
  'work.cancel': 'Cancel',
  'work.close': 'Close',
  'work.done': 'Done',
  'work.book': 'Book it',
  'work.bags': 'bags',
  'work.stepBatch': 'Batch',
  'work.stepGrams': 'Grams',
  'work.stepTarget': 'Target',
  'work.stepReport': 'Report',
  'work.stepBooked': 'Booked',
  'work.pickHarvestHint': 'Which batch did you harvest?',
  'work.pickMoveHint': 'Which batch are you moving?',
  'work.pickContamHint': 'Which batch is contaminated?',
  'work.noFruiting': 'No batch is in a fruiting room right now.',
  'work.noBatches': 'No batch is placed anywhere right now.',
  'work.noBagsInZone': 'No bag of this batch is in a fruiting room.',
  'work.noBagsStanding': 'No bag of this batch is placed anywhere right now.',
  'work.gramsHint': 'Enter what you picked per bag. Empty fields are not booked.',
  'work.already': '{g} g so far',
  'work.releaseAll': 'Release all of it for sale',
  'work.sumEmpty': 'nothing entered yet',
  'work.sumFrom': 'from {n} bags',
  'work.moveHint': '{n} bags of {batch} — where to?',
  'work.receiptTitle': 'Booked',
  'work.receiptHarvest': '{kg} {species} logged',
  ...
  'work.bStep1': 'Strain & count',
  'work.bStep2': 'Source',
  'work.bStep3': 'Check',
  'work.bQ1': 'Which strain, and how many bags?',
  'work.bQ2': 'What is the batch made from?',
  'work.bQ3': 'Does this look right?',
  'work.bLeft': '{kg} kg left',
  ...
  'work.bEditRecipe': 'Change recipe',
  'work.bCollapse': 'collapse',
  'work.bOnlyThis': 'Applies to this batch only. The strain’s recipe stays as it is.',
  'work.bMixLabel': 'Mix',
  'work.bEdit': 'change',
  'work.bNote': 'Note on this batch',
  'work.bNotePh': 'e.g. new pellet delivery, bran wetter than usual',
  'work.bNext': 'Next',
  'work.bCreate': 'Create {n} bags',
  'work.bDone': '{n} bags of {name} created',
  'work.bDrawn': '{kg} kg from {id} — {left} kg left',
  'work.bAnother': 'Another batch',
  'work.stepSubstrate': 'Substrate',
  'work.bRecipeLine': '{hw} % hardwood / {wb} % bran · {rh} % moisture · {days} days incubation',
  'work.bNoRecipe': 'This strain has no recipe yet. Enter the blend here.',
  'batch.otherWeight': 'other',
  'batch.matBag': '<strong>Bag:</strong> {kg} kg total → {dry} kg dry matter per bag ({rh} % water removed)',
  'batch.matNeed': '{need} kg needed — {have} kg in stock',
  'batch.matShort': '\u26A0 short by {kg} kg',
  'batch.matHardwood': 'Hardwood',
  'batch.matBran': 'Wheat bran',
  'batch.matCoir': 'Coir/CVG',
  'batch.matGypsum': 'Gypsum (~1 %)',
