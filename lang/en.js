...
window.LANG['en'] = {
  ...
  'strains.progOn': 'yes',
  'strains.progOff': 'no',
  'todo.supplyNow': 'no grain, nothing incubating — once the fruiting bags ({n}) are done there is nothing',
  'todo.supplyNoSpawn': 'no grain \u2014 the harvest after next has nothing to start from',
  'todo.supplyNoSorte': 'This Sorte is not listed under Pilzsorten',
  'todo.makeGrain': 'Make grain',
