...
window.LANG['en'] = {
  ...
  'orders.p.producible': 'producible (else bought-in / stock)',
  'orders.bomTitle': 'Bill of materials — material × qty per unit',
  'orders.comp.material': 'Choose material',
  'orders.materials': 'Materials / stock',
  'orders.newMaterial': '+ Material',
  'orders.mat.name': 'Material',
  'orders.mat.unit': 'Unit',
  'orders.mat.stock': 'Stock',
  'orders.matSaved': 'Material saved',
  'orders.matDeleted': 'Material deleted',
  'orders.needMatName': 'Material name required',
