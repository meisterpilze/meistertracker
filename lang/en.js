...
window.LANG['en'] = {
  ...
  'goal.set': 'Set goal',
  'goal.none': 'No weekly goal set \u2014 set one and every week counts from the day you choose.',
  'goal.week': 'Week {n}',
  'goal.met': 'met',
  'goal.missed': 'missed',
  'goal.running': 'running',
  'goal.askGoal': 'How many bags should a week bring? (0 = no goal)',
  'goal.askFrom': 'Count from when? (YYYY-MM-DD \u2014 moved to the Monday of that week)',
  ...
  'rhythm.log': 'Record',
  'rhythm.logPrompt': 'How many were made? (planned: {total})',
  'rhythm.logBad': 'Please enter a whole number of 0 or more',
  'rhythm.logged': 'Recorded',
