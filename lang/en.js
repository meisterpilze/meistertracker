...
window.LANG['en'] = {
  ...
  'msq.scan': 'Scan',
  'msq.pickManually': 'choose manually',
  'msq.noneScanned': 'nothing scanned',
  'msq.wrongCultureType': '{id} is a {type} culture — not usable here',
  'msq.create': 'Create',
  ...
  'batch.spawnSource': 'Grain spawn used (optional)',
  'batch.spawnSourceHint': 'Each bag listed here is written off when the batch is created',
  'batch.spawnPick': '— pick a grain bag —',
  'batch.spawnScan': 'Scan',
  'batch.spawnAdded': '{bag} recorded as source',
  'batch.spawnAlready': '{bag} is already listed',
  'batch.spawnNotGrain': '{bag} is not an available grain spawn bag',
