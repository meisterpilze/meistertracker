...
window.LANG['de'] = {
  ...
  'orders.p.producible': 'herstellbar (sonst Zukauf/Lager)',
  'orders.bomTitle': 'Stückliste — Material × Menge pro Stück',
  'orders.comp.material': 'Material wählen',
  'orders.materials': 'Material / Lager',
  'orders.newMaterial': '+ Material',
  'orders.mat.name': 'Material',
  'orders.mat.unit': 'Einheit',
  'orders.mat.stock': 'Bestand',
  'orders.matSaved': 'Material gespeichert',
  'orders.matDeleted': 'Material gelöscht',
  'orders.needMatName': 'Materialname erforderlich',
