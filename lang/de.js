...
window.LANG['de'] = {
  ...
  'sub.moistureActual': 'Ist-Feuchte',
  'sub.rhNotMeasured': 'noch nicht gemessen',
  'sub.rhAdd': 'Ist-Feuchte eintragen',
  'sub.rhEdit': 'Ist-Feuchte ändern',
  'sub.rhPrompt': 'Gemessene Feuchte für {id} in % (leer = löschen)',
  'sub.rhSaved': 'Ist-Feuchte {pct} % gespeichert',
  'sub.rhCleared': 'Ist-Feuchte gelöscht',
