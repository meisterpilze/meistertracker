...
window.LANG['de'] = {
  ...
  'goal.none': 'Kein Wochenziel gesetzt \u2014 festlegen, dann z\u00e4hlt jede Woche ab dem gew\u00e4hlten Tag mit.',
  'goal.week': 'KW {n}',
  'goal.met': 'geschafft',
  'goal.missed': 'verfehlt',
  'goal.running': 'l\u00e4uft',
  'goal.askGoal': 'Wie viele Beutel soll eine Woche bringen? (0 = kein Ziel)',
  'goal.askFrom': 'Ab wann z\u00e4hlen? (JJJJ-MM-TT \u2014 wird auf den Montag der Woche gelegt)',
  ...
  'rhythm.log': 'Erfassen',
  'rhythm.logPrompt': 'Wie viele wurden gemacht? (geplant: {total})',
  'rhythm.logBad': 'Bitte eine ganze Zahl ab 0 eingeben',
  'rhythm.logged': 'Erfasst',
