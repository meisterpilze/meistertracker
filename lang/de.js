...
window.LANG['de'] = {
  ...
  'msq.scan': 'Scannen',
  'msq.pickManually': 'manuell wählen',
  'msq.noneScanned': 'nichts gescannt',
  'msq.wrongCultureType': '{id} ist eine {type}-Kultur — hier nicht verwendbar',
  'msq.create': 'Anlegen',
  ...
  'batch.spawnSource': 'Verwendete Körnerbrut (optional)',
  'batch.spawnSourceHint': 'Jeder Beutel hier wird beim Anlegen der Charge abgeschrieben',
  'batch.spawnPick': '— Körnerbrut-Beutel wählen —',
  'batch.spawnScan': 'Scannen',
  'batch.spawnAdded': '{bag} als Quelle übernommen',
  'batch.spawnAlready': '{bag} ist bereits in der Liste',
  'batch.spawnNotGrain': '{bag} ist kein verfügbarer Körnerbrut-Beutel',
