...
window.LANG['de'] = {
  ...
  'contam.targetBags': '{n} Beutel',
  'contam.scanMore': '+ Beutel scannen',
  'contam.removeBag': '{bag} aus der Meldung nehmen',
  'contam.collected': '{bag} markiert ({n})',
  'contam.uncollected': '{bag} wieder freigegeben ({n})',
  'contam.reportN': 'Melden ({n})',
  'contam.reportsSaved': '{n} Berichte gespeichert',
  'contam.reportsSavedAutoMoved': '{n} Berichte gespeichert — {moved} Beutel nach CONTAM verschoben',
  'contam.type': 'Typ',
  ...
  'contam.errNoTarget': 'Kein Beutel und keine Charge in der Meldung',
  'contam.batchWhileCollecting': 'Erst die {n} gescannten Beutel melden',
