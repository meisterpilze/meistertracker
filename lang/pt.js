...
window.LANG['pt'] = {
  ...
  'msq.scan': 'Ler',
  'msq.pickManually': 'escolher manualmente',
  'msq.noneScanned': 'nada lido',
  'msq.wrongCultureType': '{id} é uma cultura {type} — não utilizável aqui',
  'batch.spawnSource': 'Grainspawn utilizado (opcional)',
  'batch.spawnSourceHint': 'Cada saco listado aqui é dado como consumido ao criar o lote',
  'batch.spawnPick': '— escolher um saco de grão —',
  'batch.spawnScan': 'Ler',
  'batch.spawnAdded': '{bag} registado como origem',
  'batch.spawnAlready': '{bag} já está na lista',
  'batch.spawnNotGrain': '{bag} não é um saco de grão disponível',
