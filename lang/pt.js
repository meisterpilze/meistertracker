...
window.LANG['pt'] = {
  ...
  'sub.burst': 'Rebentados na autoclave',
  'sub.burstNone': 'nenhum',
  'sub.burstN': '{n} saco(s)',
  'sub.burstAdd': 'Sacos rebentados',
  'sub.burstEdit': 'Alterar sacos rebentados',
  'sub.burstPrompt': 'Quantos sacos de {id} rebentaram na autoclave?',
  'sub.burstHint': 'p. ex. 4 — deixe vazio para nenhum',
  'sub.burstNaN': 'Introduza um número inteiro a partir de 0',
  'sub.burstSaved': '{n} saco(s) rebentado(s) registados',
  'sub.burstCleared': 'Registo removido — nenhum saco rebentado',
  'sub.burstSummary': '{n} saco(s) rebentado(s) em {m} preparação(ões)',
  ...
  'contam.targetBags': '{n} sacos',
  'contam.scanMore': '+ Ler sacos',
  'contam.removeBag': 'Tirar {bag} deste relatório',
  'contam.collected': '{bag} marcado ({n})',
  'contam.uncollected': '{bag} desmarcado ({n})',
  'contam.reportN': 'Reportar ({n})',
  'contam.reportsSaved': '{n} relatórios salvos',
  'contam.reportsSavedAutoMoved': '{n} relatórios salvos — {moved} saco(s) movido(s) para CONTAM',
  'contam.type': 'Tipo',
  ...
  'contam.errNoTarget': 'Nenhum saco e nenhum lote neste relatório',
  'contam.batchWhileCollecting': 'Reporte primeiro os {n} sacos lidos',
