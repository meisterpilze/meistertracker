...
window.LANG['pt'] = {
  ...
  'sub.moistureActual': 'Humidade medida',
  'sub.rhNotMeasured': 'ainda não medida',
  'sub.rhAdd': 'Registar humidade medida',
  'sub.rhEdit': 'Alterar humidade medida',
  'sub.rhPrompt': 'Humidade medida de {id} em % (vazio = apagar)',
  'sub.rhSaved': 'Humidade medida {pct} % guardada',
  'sub.rhCleared': 'Humidade medida apagada',
