...
window.LANG['pt'] = {
  ...
  'goal.set': 'Definir meta',
  'goal.none': 'Sem meta semanal \u2014 defina uma e cada semana conta a partir do dia escolhido.',
  'goal.week': 'Semana {n}',
  'goal.met': 'atingida',
  'goal.missed': 'falhada',
  'goal.running': 'a decorrer',
  'goal.askGoal': 'Quantos sacos deve render uma semana? (0 = sem meta)',
  'goal.askFrom': 'Contar a partir de quando? (AAAA-MM-DD \u2014 movido para a segunda-feira dessa semana)',
  ...
  'rhythm.log': 'Registar',
  'rhythm.logPrompt': 'Quantos foram feitos? (previsto: {total})',
  'rhythm.logBad': 'Introduza um número inteiro de 0 ou mais',
  'rhythm.logged': 'Registado',
